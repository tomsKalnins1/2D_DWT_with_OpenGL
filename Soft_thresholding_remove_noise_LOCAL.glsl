...
const float scale_parameter_beta = 3.741; // this is at level 1 decomposition
...
void set_local_Tn(){
   ...
   local_Tn[th_id.x] = ( scale_parameter_beta * local_deviation_noise[th_id.x] ) /  local_diviation_signal[th_id.x];
