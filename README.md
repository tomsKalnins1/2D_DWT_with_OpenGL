...
<table>
     <tr>
     <th align="center" width="33%">Uniform Noise <code>noise_u_0</code><br></th>
     <th align="center" width="33%"> Uniform Noise <code>noise_u_1</code><br> </th>
     <th align="center" width="33%">Additive White Gaussian Noise <code>AWGN</code><br></th>
...
| Uniform Noise `noise_u_0` | Uniform Noise `noise_u_1` | Additive White Gaussian Noise `AWGN` |
|---------------------------|---------------------------|--------------------------------------|
| <img src="Description_images/UNIFORM_NOISE_0.png" width="100%"> | <img src="Description_images/UNIFORM_NOISE_1.png" width="100%"> | <img src="IDWT_denoised/BOX_MULLER_NOISE_U_0_U_1.png" width="100%"> |
