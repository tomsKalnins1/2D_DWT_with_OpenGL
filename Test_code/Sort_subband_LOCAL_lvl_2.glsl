...
shared float input_b[64];
shared float medians_of_rows[64];
...
void store_all_from_img_to_arr(int L_H_0, int L_H_1){
    ...
    vec4 pix_r = vec4(0.0, 0.0, 0.0, 1.0);
        ...
        //HH subband
        if(L_H_0 == 1 && L_H_1 == 1){
           pix_l = imageLoad(image_O, ivec2(th_id.x + 64, th_id.y + 64));
           pix_r = imageLoad(image_O, ivec2(th_id.x + 64 + 32, th_id.y + 64));
        }

        //LH subband
        if(L_H_0 == 0 && L_H_1 == 1){
            pix_l = imageLoad(image_O, ivec2(th_id.x, th_id.y + 64));
            pix_r = imageLoad(image_O, ivec2(th_id.x + 32, th_id.y + 64));
        }

        //HL subband
        if(L_H_0 == 1 && L_H_1 == 0){
            pix_l = imageLoad(image_O, ivec2(th_id.x + 64, th_id.y));
            pix_r = imageLoad(image_O, ivec2(th_id.x + 64 + 32, th_id.y));
        }
...
void store_all_from_arr_to_img(int L_H_0, int L_H_1){
    ...
    vec4 pix_r = vec4(pix_r_val, pix_r_val, pix_r_val, 1.0);
        ...
        //HH subband
        if(L_H_0 == 1 && L_H_1 == 1){
            imageStore(image_T, ivec2(th_id.x + 64, th_id.y + 64), pix_l);
            imageStore(image_T, ivec2(th_id.x + 64 + 32, th_id.y + 64), pix_r);
        }

        //LH subband
        if(L_H_0 == 0 && L_H_1 == 1){
            imageStore(image_T, ivec2(th_id.x, th_id.y + 64), pix_l);
            imageStore(image_T, ivec2(th_id.x + 32, th_id.y + 64), pix_r);
        }

        //HL subband
        if(L_H_0 == 1 && L_H_1 == 0){
            imageStore(image_T, ivec2(th_id.x + 64, th_id.y), pix_l);
            imageStore(image_T, ivec2(th_id.x + 64 + 32, th_id.y), pix_r);
        }
